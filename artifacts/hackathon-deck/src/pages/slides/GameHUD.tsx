      ...
      <div className="relative h-full w-full flex">
        <div className="w-[42vw] flex flex-col pt-[7vh] pl-[6vw] pr-[3vw]">
          ...
          <h2 className="font-display font-bold text-[4.4vw] mt-[1.5vh] leading-tight">
            A Fantasy-Themed Overlay
          </h2>
          <div className="mt-[2vh] h-[0.15vh] w-[6vw] bg-primary" />

          <div className="mt-[4vh] flex flex-col gap-[2vh] text-[2.5vw] leading-snug">
            <p>Vitality Elixir health bar</p>
            <p>Wallet address and network badge, top-right</p>
            <p>Arcana score and four Essence inventory slots</p>
            <p>Contextual hint toasts</p>
            <p className="text-muted">All driven by a central Zustand store</p>
          </div>
        </div>
