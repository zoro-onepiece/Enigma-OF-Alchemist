 ...
 */
// Exported so DistantScenery.tsx can render small purely-decorative copies
// of this same pack (no collision registration) on its floating islands,
...
export const FOREST_BRANCH_NODES = [
...
export const FOREST_VARIANT_BOUNDS: { height: number; baseOffset: number }[] = [
  { height: 20.4508, baseOffset: 7.9675 },
  { height: 23.0844, baseOffset: 7.7003 },
  { height: 19.0446, baseOffset: 7.7282 },
  { height: 10.2039, baseOffset: 4.341 },
];

const MODEL_PATH = FOREST_TREE_MODEL_PATH;
...
const TRUNK_NODES = FOREST_TRUNK_NODES;
const BRANCH_NODES = FOREST_BRANCH_NODES;
...
const AXIS_FIX_ROTATION = FOREST_TREE_AXIS_FIX_ROTATION;
