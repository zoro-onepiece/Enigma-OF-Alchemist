      ...
      <div className="relative w-full max-w-md lg:max-w-xl xl:max-w-2xl mx-3 sm:mx-4 rounded-2xl border-2 border-amber-700/60 bg-gradient-to-b from-stone-900 to-stone-950 p-4 sm:p-8 lg:p-10 xl:p-12 shadow-2xl shadow-black/60 font-serif max-h-[90vh] overflow-y-auto">
        ...
        {victorious ? (
          ...
          >
            ...
            {relic ? (
              <div className="relative flex flex-col items-center mb-6">
                <img
                  src={relic.image}
                  alt={relic.name}
                  className="w-28 h-28 lg:w-36 lg:h-36 object-contain mb-3"
                  style={{ animation: "nft-glow 2s ease-in-out infinite" }}
                />
                <p className="text-amber-300 font-bold text-lg lg:text-2xl tracking-wide mb-1 shadow-black drop-shadow-md">
            ...
            <p className="relative text-emerald-300/90 text-sm lg:text-base xl:text-lg italic mb-6 lg:mb-8">{flavorText}</p>            <button
